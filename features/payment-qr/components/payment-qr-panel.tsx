        ...
        {hasQrPreview ? (
          <div className="space-y-3">
            <Dialog>
              ...
              <DialogContent className="max-w-3xl">
                <DialogHeader>
                  <DialogTitle>
                    {employee.full_name ?? 'QR thanh toán'}
                  </DialogTitle>
                  <DialogDescription>
                    Mở lớn mã QR để thao tác chuyển khoản nhanh hơn.
                  </DialogDescription>
                </DialogHeader>
          ...
          <div className="max-w-md text-center">
            ...
            <p className="mt-4 text-lg font-semibold">
              {hasSavedQr
                ? 'Chưa tải được bản xem trước của mã QR'
                : 'Nhân sự này chưa cập nhật mã QR'}
            </p>
